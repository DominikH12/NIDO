...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($passwort !== $passwort_bestaetigung) {
        ...
        try {
            $stmt = $conn->prepare("INSERT INTO admin (username, passwort) VALUES (:username, :passwort)");
...
<body>
    <div class="container">
        ...
        <div class="link">
            Bereits registriert? <a href="login_a.php">Hier einloggen</a>
        </div>
    </div>
</body>
</html>
